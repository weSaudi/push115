...
const handleOutgoingChat = () => {
  ...
  let arabic = "انت مساعد في تعلم الطلاب قواعد اللغة العربية والكتابة الصحيحة للجمل باللغة العربية عليك تصحيح الجملة"+userMessage +" وفق قواعد اللغة العربية مع شرح القاعدة";
